...
CREATE TABLE `userwishlist` (
  ...
  KEY `bookID` (`bookID`),
  CONSTRAINT `userwishlist_ibfk_1` FOREIGN KEY (`userName`) REFERENCES `user` (`userName`),
  CONSTRAINT `userwishlist_ibfk_2` FOREIGN KEY (`bookID`) REFERENCES `books` (`bookID`)
...
-- Dump completed on 2023-08-22 15:06:24
